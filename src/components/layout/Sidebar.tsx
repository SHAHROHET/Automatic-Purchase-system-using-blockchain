...
const navigation = [
  ...
  { name: 'Purchase Orders', href: '/purchase-orders', icon: 'orders' },
  { name: 'Suppliers', href: '/suppliers', icon: 'suppliers' },
  { name: 'Inventory', href: '/inventory', icon: 'inventory' },
  { name: 'Shipments', href: '/shipments', icon: 'shipments' },
...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-[280px] bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-200">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">WADEIN</h1>
        ...
        <div className="px-4 py-4 border-t border-gray-200 space-y-2">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">WADEIN Admin</p>
              <p className="text-xs text-gray-500 truncate">admin@wadein.com.au</p>
            </div>
          </div>
          <button
